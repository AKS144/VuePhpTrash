<template>
  <div>
      <div id="toolbar">
          ...
          <a href="/recycle-posts" class="btn btn-danger"><i class="fas fa-trash-alt"></i>Recycle Bin</a>
          <button class="btn btn-danger" @click="checkPosts"><i class="fas fa-minus-circle"></i>Delete Selected</button>
      </div>
      <bootstrap-table :data="myPosts" :options="myOptions" :columns="myColumn"/>
  </div>
</template>
